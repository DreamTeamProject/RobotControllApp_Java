...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00471();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C02542();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C00471 implements ThreadFactory {
    ...
    class C02542 extends WorkerRunnable<Params, Result> {
        C02542() {
            super();
        }
