...
public class TextInputLayout extends LinearLayout {
    ...
    class C02444 implements AnimatorUpdateListener {
        C02444() {
        }
    ...
    class C03052 extends ViewPropertyAnimatorListenerAdapter {
        C03052() {
        }
    ...
    class C03063 extends ViewPropertyAnimatorListenerAdapter {
        C03063() {
        }
    ...
    public void setError(@Nullable CharSequence error) {
        ...
        if (!TextUtils.isEmpty(error)) {
            ...
            ViewCompat.animate(this.mErrorView).alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).setListener(new C03052()).start();
            this.mErrorShown = true;
            updateEditTextBackground();
            updateLabelVisibility(true);
        } else if (this.mErrorView.getVisibility() == 0) {
            ViewCompat.animate(this.mErrorView).alpha(0.0f).setDuration(200).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).setListener(new C03063()).start();
            this.mErrorShown = false;
            updateEditTextBackground();
        }
    }
    ...
    private void animateToExpansionFraction(float target) {
        if (this.mCollapsingTextHelper.getExpansionFraction() != target) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.setUpdateListener(new C02444());
            }
