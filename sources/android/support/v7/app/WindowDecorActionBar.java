...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C03101();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C03112();
    private boolean mShowingForMode;
    private ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    private TintManager mTintManager;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02813();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C02813 implements ViewPropertyAnimatorUpdateListener {
        C02813() {
        }
    ...
    class C03101 extends ViewPropertyAnimatorListenerAdapter {
        C03101() {
        }
    ...
    class C03112 extends ViewPropertyAnimatorListenerAdapter {
        C03112() {
        }
    ...
    private void init(View decor) {
        ...
        if (a.getBoolean(C0158R.styleable.ActionBar_hideOnContentScroll, false)) {
