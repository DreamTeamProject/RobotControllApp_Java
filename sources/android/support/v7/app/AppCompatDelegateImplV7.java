...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    private final Runnable mInvalidatePanelMenuRunnable = new C01531();
    ...
    class C01545 implements Runnable {
        ...
        class C03071 extends ViewPropertyAnimatorListenerAdapter {
            C03071() {
            }
        ...
        public void run() {
            ...
            AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C03071());
        }
    }
    ...
    private static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02791());
            int featureId;
            boolean isOpen;
            Bundle menuState;
        ...
        void setStyle(Context context) {
            ...
            TypedArray a = context2.obtainStyledAttributes(C0158R.styleable.Theme);
            this.background = a.getResourceId(C0158R.styleable.Theme_panelBackground, 0);
            this.windowAnimations = a.getResourceId(C0158R.styleable.Theme_android_windowAnimationStyle, 0);
            a.recycle();
        }
    ...
    class C02762 implements OnApplyWindowInsetsListener {
        C02762() {
        }
    ...
    class C02773 implements OnFitSystemWindowsListener {
        C02773() {
        }
    ...
    class C02784 implements OnAttachListener {
        C02784() {
        }
    ...
    class ActionModeCallbackWrapperV7 implements ActionMode.Callback {
        ...
        class C03091 extends ViewPropertyAnimatorListenerAdapter {
            C03091() {
            }
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV7.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C03091());
            }
    ...
    class C03086 extends ViewPropertyAnimatorListenerAdapter {
        C03086() {
        }
    ...
    private ViewGroup createSubDecor() {
        TypedArray a = this.mContext.obtainStyledAttributes(C0158R.styleable.Theme);
        if (a.hasValue(C0158R.styleable.Theme_windowActionBar)) {
            if (a.getBoolean(C0158R.styleable.Theme_windowNoTitle, false)) {
                requestWindowFeature(1);
            } else if (a.getBoolean(C0158R.styleable.Theme_windowActionBar, false)) {
                requestWindowFeature(108);
            }
            if (a.getBoolean(C0158R.styleable.Theme_windowActionBarOverlay, false)) {
                requestWindowFeature(109);
            }
            if (a.getBoolean(C0158R.styleable.Theme_windowActionModeOverlay, false)) {
                requestWindowFeature(10);
            }
            this.mIsFloating = a.getBoolean(C0158R.styleable.Theme_android_windowIsFloating, false);
            a.recycle();
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new C02762());
                } else {
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new C02773());
                }
            ...
            abcContent.setAttachListener(new C02784());
            return subDecor;
        }
        a.recycle();
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(C0158R.styleable.Theme);
        a.getValue(C0158R.styleable.Theme_windowMinWidthMajor, cfl.getMinWidthMajor());
        a.getValue(C0158R.styleable.Theme_windowMinWidthMinor, cfl.getMinWidthMinor());
        if (a.hasValue(C0158R.styleable.Theme_windowFixedWidthMajor)) {
            a.getValue(C0158R.styleable.Theme_windowFixedWidthMajor, cfl.getFixedWidthMajor());
        }
        if (a.hasValue(C0158R.styleable.Theme_windowFixedWidthMinor)) {
            a.getValue(C0158R.styleable.Theme_windowFixedWidthMinor, cfl.getFixedWidthMinor());
        }
        if (a.hasValue(C0158R.styleable.Theme_windowFixedHeightMajor)) {
            a.getValue(C0158R.styleable.Theme_windowFixedHeightMajor, cfl.getFixedHeightMajor());
        }
        if (a.hasValue(C0158R.styleable.Theme_windowFixedHeightMinor)) {
            a.getValue(C0158R.styleable.Theme_windowFixedHeightMinor, cfl.getFixedHeightMinor());
        }
        a.recycle();
        cfl.requestLayout();
    }
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    this.mFadeAnim.setListener(new C03086());
                    if (this.mActionModePopup != null) {
