...
public class StaggeredGridLayoutManager extends LayoutManager {
    ...
    private final Runnable mCheckForGapsRunnable = new C01981();
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Creator<FullSpanItem> CREATOR = new C01991();
            int mGapDir;
            int[] mGapPerSpan;
            ...
            static class C01991 implements Creator<FullSpanItem> {
                C01991() {
                }
