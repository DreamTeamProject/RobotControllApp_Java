...
class AppCompatTextHelper {
    private static final int[] TEXT_APPEARANCE_ATTRS = new int[]{C0158R.attr.textAllCaps};
    ...
    void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        if (ap != -1) {
            ...
            if (appearance.hasValue(C0158R.styleable.TextAppearance_textAllCaps)) {
                setAllCaps(appearance.getBoolean(C0158R.styleable.TextAppearance_textAllCaps, false));
            }
            appearance.recycle();
        }
