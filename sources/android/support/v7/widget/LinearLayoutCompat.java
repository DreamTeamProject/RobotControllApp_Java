...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public LinearLayoutCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0158R.styleable.LinearLayoutCompat, defStyleAttr, 0);
        ...
        this.mShowDividers = a.getInt(C0158R.styleable.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = a.getDimensionPixelSize(C0158R.styleable.LinearLayoutCompat_dividerPadding, 0);
        a.recycle();
    }
