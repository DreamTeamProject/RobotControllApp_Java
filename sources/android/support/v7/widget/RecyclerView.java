...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    private static final Interpolator sQuinticInterpolator = new C01853();
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            properties.orientation = a.getInt(C0159R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0159R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0159R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0159R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    }
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C01861();
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0159R.styleable.RecyclerView, defStyle, 0);
