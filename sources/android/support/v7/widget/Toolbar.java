...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowOverflowMenuRunnable = new C02022();
        ...
        int contentInsetStart = a.getDimensionPixelOffset(C0158R.styleable.Toolbar_contentInsetStart, Integer.MIN_VALUE);
        int contentInsetEnd = a.getDimensionPixelOffset(C0158R.styleable.Toolbar_contentInsetEnd, Integer.MIN_VALUE);
        this.mContentInsets.setAbsolute(a.getDimensionPixelSize(C0158R.styleable.Toolbar_contentInsetLeft, 0), a.getDimensionPixelSize(C0158R.styleable.Toolbar_contentInsetRight, 0));
    ...
    private void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            ...
            this.mCollapseButtonView.setOnClickListener(new C02033());
        }
    }
