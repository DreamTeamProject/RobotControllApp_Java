...
public class ListPopupWindow {
    ...
    public ListPopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0158R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, 0);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0158R.styleable.ListPopupWindow_android_dropDownVerticalOffset, 0);
